...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputBankCardCode = __webpack_require__(201);

	var _InputBankCardCode2 = _interopRequireDefault(_InputBankCardCode);

	var _InputMobileNo = __webpack_require__(205);

	var _InputMobileNo2 = _interopRequireDefault(_InputMobileNo);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var TitleDemo = _react2.default.createClass({
		displayName: 'TitleDemo',

		render: function render() {
			var title = this.props.title || 'default title';
	...
	var ValidateCode = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'ipt-controll' },
						_react2.default.createElement(
							'div',
							{ className: 'ipt-holder' },
							_react2.default.createElement(
								'div',
								{ className: 'ipt-3-left' },
								_react2.default.createElement(
									'span',
									null,
									'验证码'
							...
							_react2.default.createElement(
								'div',
								{ className: 'ipt-3-mid' },
								_react2.default.createElement('input', { className: 'v-ipt', type: 'tel', id: 'authCode',
									placeholder: '请输入短信验证码' }),
								_react2.default.createElement('i', { className: 'icon-delet del hide' })
							),
							_react2.default.createElement(
								'div',
								{ className: 'ipt-3-right v-btn-link-holder ipt-sp-v-line' },
								_react2.default.createElement(
									'button',
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'container' },
				_react2.default.createElement(Head, { title: '钱包明细页面' }),
				_react2.default.createElement(Banner, { title: '这是一个默认的 banner 条' }),
				_react2.default.createElement(TitleDemo, { title: '验证码' }),
				_react2.default.createElement(ValidateCode, null),
				_react2.default.createElement(TitleDemo, { title: '银行卡' }),
				_react2.default.createElement(_InputBankCardCode2.default, null),
				_react2.default.createElement(TitleDemo, { title: '手机号码' }),
				_react2.default.createElement(_InputMobileNo2.default, null)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./demo.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js!./demo.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputItem = __webpack_require__(202);

	var _InputItem2 = _interopRequireDefault(_InputItem);

	var _inputFormat = __webpack_require__(203);
	...
	var InputBankCardCode = _react2.default.createClass({
		displayName: 'InputBankCardCode',
		render: function render() {
			function handleChangeFormat(value) {
				return (0, _inputFormat.inputFormat)(value, 'card_split');
			}
			function handleBlurCheck(value) {
				var rst = _validate2.default.bankcardNo((0, _inputFormat.clearSpace)(value));
				console.log(rst);
			}
			...
			return _react2.default.createElement(_InputItem2.default, {
				...
				handleBlurCheck: handleBlurCheck
			});
		}
	});
	exports.default = InputBankCardCode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputItem = _react2.default.createClass({
		...
		handleBlur: function handleBlur(event) {
			...
			var timeout = setTimeout(function () {
				...
				//checkout
				var handleBlurCheck = self.props.handleBlurCheck;
				var value = self.state.value;
				var isClearValueByHand = self.state.isClearValueByHand;
				if (typeof handleBlurCheck === 'function') {
					if (value !== '' || !isClearValueByHand) handleBlurCheck(value);
				}
				clearTimeout(timeout);
			}, 300);
		},
		handleDelClick: function handleDelClick(event) {
			this.setState({
				value: '',
				isClearValueByHand: true
			});
		},
		handleChangeDefault: function handleChangeDefault(event) {
			var value = event.target.value;
			var handleChangeFormat = this.props.handleChangeFormat;
			if (typeof handleChangeFormat === 'function') {
				this.setState({ value: handleChangeFormat(value) });
			} else {
				this.setState({ value: value });
			}
		},
		render: function render() {
			var delClass = (0, _classnames2.default)('icon-delet', 'del', { 'hide': !this.state.focus });
			return _react2.default.createElement(
				'div',
				{ className: 'row' },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('i', { className: delClass, onClick: this.handleDelClick })
							)
						)
					)
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputMobileNo = _react2.default.createClass({
		displayName: 'InputMobileNo',
		render: function render() {
			function handleChangeFormat(value) {
				return (0, _inputFormat.inputFormat)(value, 'mobile_split');
			}
			function handleBlurCheck(value) {
				// var rst = validate.bankcardNo(clearSpace(value))
				// console.log(rst)
			}
